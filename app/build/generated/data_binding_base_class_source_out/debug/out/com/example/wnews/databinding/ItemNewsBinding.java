...
public final class ItemNewsBinding implements ViewBinding {
  ...
  private ItemNewsBinding(@NonNull LinearLayout rootView, @NonNull TextView detailNewsItem,
      @NonNull ImageButton imageButtonLikeItem, @NonNull SimpleDraweeView imageNewsItem,
      @NonNull TextView titleNewsItem) {
  ...
  public static ItemNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNewsBinding((LinearLayout) rootView, detailNewsItem, imageButtonLikeItem,
          imageNewsItem, titleNewsItem);
    }
